package com.example.a48koscirozbudowane;

import androidx.activity.EdgeToEdge;
import androidx.annotation.RequiresApi; // Minimum API 29
...
import android.media.AudioManager; // Dla "beep"
import android.media.ToneGenerator; // Dla "beep"
import android.media.MediaPlayer; // Dla *.mp3
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView sumaOczekTekst, sumaOgolnaTekst, liczbaProbTekst,
            wylosowaneLiczbyTekst;
    // "final" wtedy, gdy nie będzie ulegał w dalszej części kodu żadnym zmianom (stała):
    private final int kostkaZnakZapytania = R.drawable.znak_zapytania;
    int sumaOgolna = 10;
    int sumaOczek = 0;
    private int liczbaProb = 30;
    ...
    private void rzucKoscmi() {
        ...
        int[] wylosowaneOczka = {wynikLosowaniaKostka1 + 1, wynikLosowaniaKostka2 + 1,
                wynikLosowaniaKostka3 + 1, wynikLosowaniaKostka4 + 1, wynikLosowaniaKostka5 + 1};
